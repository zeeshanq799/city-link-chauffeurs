...
@section('header', 'Edit Package: ' . $package->name)
...
<div class="flex items-center gap-2">
    <x-button href="{{ route('admin.packages.show', $package) }}" variant="secondary" icon="M15 12a3 3 0 11-6 0 3 3 0 016 0z">
        View Package
    </x-button>
...
@section('content')
<form action="{{ route('admin.packages.update', $package) }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="{
    name: '{{ old('name', $package->name) }}',
    basePrice: {{ old('base_price', $package->base_price) }},
    discountPrice: {{ old('discount_price', $package->discount_price ?? 0) }},
    get slug() {
    ...
    <div class="card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                >
                <p class="mt-1 text-xs text-gray-500">Current: {{ $package->slug }}</p>
                @error('slug')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                >
                    ...
                    <option value="airport" {{ old('category', $package->category) === 'airport' ? 'selected' : '' }}>✈️ Airport Transfer</option>
                    ...
                    <option value="city_tour" {{ old('category', $package->category) === 'city_tour' ? 'selected' : '' }}>🏙️ City Tour</option>
                    <option value="group" {{ old('category', $package->category) === 'group' ? 'selected' : '' }}>👥 Group</option>
                    <option value="custom" {{ old('category', $package->category) === 'custom' ? 'selected' : '' }}>⭐ Custom</option>
                </select>
                @error('category')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" required class="@error('description') border-red-500 @enderror">{{ old('description', $package->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
    ...
    <div class="card p-6">
        ...
        <div class="mb-4">
            ...
            <img src="{{ $package->featured_image_url }}" alt="{{ $package->name }}" class="w-48 h-32 object-cover rounded-lg border border-gray-200">
        </div>
        @endif
        
        <div>
            <label for="featured_image" class="block text-sm font-medium text-gray-700 mb-2">
                {{ $package->featured_image_url ? 'Replace Image' : 'Upload Image' }}
            </label>
            <input 
                type="file" 
                name="featured_image" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input 
                    ...
                    value="{{ old('passenger_capacity', $package->passenger_capacity) }}"
                    required
                    min="1"
            ...
            <div>
                ...
                <input 
                    ...
                    id="luggage_capacity" 
                    value="{{ old('luggage_capacity', $package->luggage_capacity) }}"
                    min="0"
            ...
            <div>
                ...
                <input 
                    ...
                    value="{{ old('min_booking_hours', $package->min_booking_hours) }}"
                    min="1"
            ...
            <div class="md:col-span-2">
                <label class="flex items-center">
                    <input 
                        ...
                        value="1"
                        {{ old('availability_24_7', $package->availability_24_7) ? 'checked' : '' }}
                ...
                <div class="flex gap-4">
                    <label class="flex items-center">
                        <input 
                            ...
                            name="pricing_type" 
                            value="fixed"
                            {{ old('pricing_type', $package->pricing_type) === 'fixed' ? 'checked' : '' }}
                    ...
                    <label class="flex items-center">
                        <input 
                            ...
                            name="pricing_type" 
                            value="hourly"
                            {{ old('pricing_type', $package->pricing_type) === 'hourly' ? 'checked' : '' }}
                            class="text-primary-600 focus:ring-primary-500"
                        >
                    ...
                    <label class="flex items-center">
                        <input 
                            ...
                            name="pricing_type" 
                            value="daily"
                            {{ old('pricing_type', $package->pricing_type) === 'daily' ? 'checked' : '' }}
                            class="text-primary-600 focus:ring-primary-500"
                        >
    ...
    <div class="card p-6">
        ...
        <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <label class="flex items-start">
                        <input 
                            ...
                            name="inclusions[]" 
                            value="{{ $inclusion }}"
                            {{ in_array($inclusion, old('inclusions', $package->inclusions ?? [])) ? 'checked' : '' }}
            ...
            <div>
                ...
                >{{ old('exclusions_text', $package->exclusions ? implode("\n", $package->exclusions) : '') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input 
                        ...
                        name="vehicle_type" 
                        id="vehicle_type" 
                        value="{{ old('vehicle_type', $package->quick_facts['vehicle'] ?? '') }}"
                        class="input-field"
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('availability_text', $package->quick_facts['availability'] ?? '24/7') }}"
                        class="input-field"
    ...
    <div class="card p-6">
        ...
        <div class="space-y-6">
            <div>
                ...
                <textarea name="terms_conditions" id="terms_conditions" class="@error('terms_conditions') border-red-500 @enderror">{{ old('terms_conditions', $package->terms_conditions) }}</textarea>
            ...
            <div>
                ...
                <textarea name="cancellation_policy" id="cancellation_policy" class="@error('cancellation_policy') border-red-500 @enderror">{{ old('cancellation_policy', $package->cancellation_policy) }}</textarea>
